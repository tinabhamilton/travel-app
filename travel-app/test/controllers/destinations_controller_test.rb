...
class DestinationsControllerTest < ActionController::TestCase
  ...
  test "should create destination" do
    assert_difference('Destination.count') do
      post :create, destination: { address: @destination.address, city: @destination.city, country: @destination.country }
    end
  ...
  test "should update destination" do
    patch :update, id: @destination, destination: { address: @destination.address, city: @destination.city, country: @destination.country }
    assert_redirected_to destination_path(assigns(:destination))
  end
